...
// Helper: treat as heading if canonicalId is a slug of label and label is present
function newSectionIsHeading(section: any): boolean {
  return section.label && section.canonicalId === toSlug(section.label);
}
